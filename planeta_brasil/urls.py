...
urlpatterns = patterns('',
    ...
    url(r'^api/cultural_programming/$', 'planeta_brasil.api_copa.views.api_cultural_programming', name='api_cultural_programming'),
    url(r'^api/cultural_programming/(?P<pk>\d)/$', 'planeta_brasil.api_copa.views.api_cultural_programming_detail', name='api_cultural_programming_detail'),
